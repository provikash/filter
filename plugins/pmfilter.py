...
async def give_filter(client, message):
    ...
    if message.chat.id != SUPPORT_CHAT_ID:
        ...
        if total_results == 0:
            ...
            reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("🔍 ᴊᴏɪɴ ᴀɴᴅ ꜱᴇᴀʀᴄʜ ʜᴇʀᴇ 🔎", url=f"https://t.me/+i2ObEOcngso1YWE9")]]))
    ...
    try:
        ...
        if pm_search:
            ...
            await message.reply_text(
             ...
             reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("📝 ʀᴇǫᴜᴇsᴛ ʜᴇʀᴇ ", url=f"https://t.me/+i2ObEOcngso1YWE9")]])
            )
...
#Deendayal403
        ...
        buttons = [[
            InlineKeyboardButton('Sᴏᴜʀᴄᴇ Cᴏᴅᴇ 📜', url='https://t.me/movieshd_09'),
    ...
    if imdb:
        ...
        if settings["button"]:
            ...
            for file in files:
                ...
                # Use get_cap function to include advertisements
    if not settings["button"]:
        cap = await get_cap(settings, remaining_seconds, files, message, total_results, search)
